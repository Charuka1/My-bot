...
if(senderNumber.includes("94718939447")){
if(isReact) return
m.react("👻")
}
...
app.get("/", (req, res) => {
res.send("hey, mizuki md bot started🧚‍♂️");
});
app.listen(port, () => console.log(`mizuki md Server listening on port http://localhost:${port}`));
setTimeout(() => {
connectToWA()
}, 4000);  
